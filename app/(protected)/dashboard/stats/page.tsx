    ...
    >
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 dark:from-white dark:via-purple-100 dark:to-white bg-clip-text text-transparent">
              Writing Statistics
            </h1>
            <p className="text-sm text-slate-600 dark:text-gray-400">Track your progress and stay motivated</p>
          </div>
        </div>
        ...
        >
          {/* Today's Progress */}
          <div className="group relative p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 hover:border-purple-400 dark:hover:border-purple-500/30 hover:bg-slate-50 dark:hover:bg-white/[0.04] shadow-sm dark:shadow-none transition-all overflow-hidden flex flex-col justify-between">
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400">
                ...
                <span className="text-xs font-semibold">Today's Goal</span>
              </div>
              <button
                onClick={() => setShowGoalEdit(true)}
                className="p-1.5 rounded-lg text-slate-400 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-500/20 transition-all z-10"
                title="Edit Goal"
              >
            ...
            <div className="space-y-3 z-10">
              <div className="flex items-baseline gap-1">
                ...
                <p className="text-sm text-slate-500 dark:text-gray-500 font-medium">/ {stats.dailyGoal}</p>
              </div>
              <div>
                <div className="w-full bg-slate-200 dark:bg-black/40 rounded-full h-1.5 mb-1.5 overflow-hidden">
                  <div
                    className="bg-gradient-to-r from-purple-500 to-pink-500 h-full rounded-full transition-all duration-500"
                    style={{ width: `${goalProgress}%` }}
                  />
                </div>
                <p className="text-[10px] text-slate-500 dark:text-gray-500 font-medium uppercase tracking-wider">{goalProgress}% complete</p>
              </div>
            </div>
          </div>

          {/* Writing Streak */}
          <div className="group relative p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 hover:border-orange-400 dark:hover:border-orange-500/30 hover:bg-slate-50 dark:hover:bg-white/[0.04] shadow-sm dark:shadow-none transition-all overflow-hidden flex flex-col justify-between">
            ...
            <div className="flex items-center gap-2 text-orange-600 dark:text-orange-400 mb-3">
              ...
              <span className="text-xs font-semibold">Writing Streak</span>
            </div>
            <div className="z-10 mt-auto">
              <p className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight mb-1">{stats.streak}</p>
              <p className="text-[10px] text-slate-500 dark:text-gray-500 font-medium uppercase tracking-wider">consecutive days</p>
            </div>
          </div>

          {/* Total Words */}
          <div className="group relative p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 hover:border-blue-400 dark:hover:border-blue-500/30 hover:bg-slate-50 dark:hover:bg-white/[0.04] shadow-sm dark:shadow-none transition-all overflow-hidden flex flex-col justify-between">
            ...
            <div className="z-10 mt-auto">
              ...
              <p className="text-[10px] text-slate-500 dark:text-gray-500 font-medium uppercase tracking-wider">across all projects</p>
            </div>
          </div>

          {/* Average Per Day */}
          <div className="group relative p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 hover:border-emerald-400 dark:hover:border-emerald-500/30 hover:bg-slate-50 dark:hover:bg-white/[0.04] shadow-sm dark:shadow-none transition-all overflow-hidden flex flex-col justify-between">
            ...
            <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 mb-3">
              ...
              <span className="text-xs font-semibold">Daily Average</span>
            </div>
            <div className="z-10 mt-auto">
              <p className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight mb-1">
                {stats.avgWordsPerDay}
              </p>
              <p className="text-[10px] text-slate-500 dark:text-gray-500 font-medium uppercase tracking-wider">words per day</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none relative overflow-hidden group hover:border-purple-400 dark:hover:border-purple-500/20 transition-all">
          ...
          {/* Progress Stats */}
          <div className="p-5 rounded-2xl bg-white dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none relative overflow-hidden group hover:border-emerald-400 dark:hover:border-emerald-500/20 transition-all">
            <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/5 blur-[40px] rounded-full pointer-events-none" />
            <div className="flex items-center gap-2 mb-6 relative z-10">
              <Award className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
              <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Progress Overview</h3>
            </div>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs text-slate-600 dark:text-gray-400 font-medium">Phases Completed</span>
              ...
              <div className="space-y-2">
                <p className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wider mb-3">Milestones</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {[
                    ...
                    return (
                      <div
                        key={milestone.words}
                        className={`flex items-center gap-2 p-2.5 rounded-xl border transition-all ${achieved
                            ? "bg-emerald-50 dark:bg-emerald-500/10 border-emerald-200 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-300"
                            : "bg-slate-50 dark:bg-white/[0.02] border-slate-200 dark:border-white/5 text-slate-400 dark:text-gray-500"
                          }`}
                      >
                        {achieved ? (
                        ...
                        <span className={`text-xs font-medium truncate ${achieved ? "text-emerald-800 dark:text-emerald-300" : "text-slate-500 dark:text-gray-400"}`}>
                          {milestone.label}
                        </span>
                      </div>
                    );
